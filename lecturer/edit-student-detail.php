...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $eid = $_GET['editid'];
    $sql = "update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address, CGPA=:cgpa, Department =:department where ID=:eid";
  ...
  <head>
    ...
    <title>MMP Management System || Update Students</title>
    <!-- plugins:css -->
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) { ?>
                          ...
                          <div class="form-group">
                            ...
                            <select name="stuclass" class="form-control" required='true'>
                              ...
                              foreach ($result2 as $row1) {
                                ?>
                                <option
                                  value="<?php echo htmlentities($row1->ClassName); ?><?php echo htmlentities($row1->Section); ?>">
                          ...
                          <div class="form-group">
                            <label for="exampleInputName1">CGPA</label>
                            <input type="text" name="cgpa" value="<?php echo htmlentities($row->CGPA); ?>"
                              class="form-control" required='true'>
                          </div>

                          <div class="form-group">
                            <label for="exampleInputName1">Department</label>
                            <input type="text" name="department" value="<?php echo htmlentities($row->Department); ?>"
                              class="form-control" required='true'>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputName1">Student Photo</label>
                            <img src="images/<?php echo $row->Image; ?>" width="100" height="100"
                              value="<?php echo $row->Image; ?>"><a href="changeimage.php?editid=<?php echo $row->ID; ?>">
                              &nbsp; Edit Image</a>
                          </div>
