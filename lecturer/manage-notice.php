                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Group Notice</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Group Notice</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Mentor</th>
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT tblclass.ID,tblclass.ClassName,tblclass.Section,tblnotice.NoticeTitle,tblnotice.CreationDate,tblnotice.ClassId,tblnotice.ID as nid from tblnotice join tblclass on tblclass.ID=tblnotice.ClassId WHERE tblclass.ClassName = '8' LIMIT $offset, $no_of_records_per_page  ";
                          $query = $dbh->prepare($sql);
                          $query->execute();
