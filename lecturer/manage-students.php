...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  <head>
    ...
    <title>MMP Management System ||| View Students Group 8 </title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Students (Group 8) </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> List all Students</a>
                    </div>
