...
if (strlen($_SESSION['sturecmsstuid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $date = $_POST['date'];
    $time = $_POST['time'];
    $sql = "insert into tblappoinment(AppTitle,Description,Date,Time) values(:apptitle,:desc,:date,:time)";
  ...
  <head>
    ...
    <title>MMP Management System || Add Appointment</title>
    <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="apptitle" value="" class="form-control" required='true'>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputName1">Description</label>
                        <input type="text" name="desc" value="" class="form-control" required='true'>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="time" value="" class="form-control" required='true'>
                      </div>
