...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() == 0) {
      ...
      if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql = "insert into tblstudent(StudentName,StudentEmail,StudentClass,Gender,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image,CGPA)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image,:cgpa)";
  ...
  <head>
    ...
    <title>MMP Management System || Add Students</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Student Matric No</label>
                        <input type="text" name="stuid" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">CGPA</label>
                        <input type="text" name="cgpa" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
