...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  <head>
    ...
    <title>MMP Management System ||| Manage Group</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Group</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Groups</a>
                    </div>
