...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  <head>
    ...
    <title>MMP Management System ||| Manage Students</title>
    <!-- plugins:css -->
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Matric No</th>
                            <th class="font-weight-bold">Group Mentor</th>
                            <th class="font-weight-bold">Student Name</th>
                            <th class="font-weight-bold">Department</th>
                            <th class="font-weight-bold">CGPA</th>
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail, tblstudent.Department,tblstudent.CGPA, tblstudent.DateofAdmission, tblclass.ClassName,tblclass.Section from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass ORDER BY tblclass.ClassName ASC LIMIT $offset, $no_of_records_per_page";
                          $query = $dbh->prepare($sql);
                          $query->execute();
                          ...
                          if ($query->rowCount() > 0) {
                            foreach ($results as $row) { ?>
                              <tr>
                                ...
                                <td>
                                  <?php echo htmlentities($row->CGPA); ?>
                                </td>
                                <td>
                    ...
                    <div align="left">
                      <ul class="pagination">
                        ...
                        <li class="<?php if ($pageno <= 1) {
                          ...
                          } ?>"><strong style="padding-left: 10px">Previous></strong></a>
                        </li>
