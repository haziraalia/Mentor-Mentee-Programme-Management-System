                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Total Group</span>
                          <h4>
                            <?php echo htmlentities($totclass); ?>
                          </h4>
                          <a href="manage-class.php"><span class="report-count"> View Groups</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php
                          $sql4 = "SELECT * from  tblappoinment";
                          $query4 = $dbh->prepare($sql4);
                          $query4->execute();
                          $results4 = $query4->fetchAll(PDO::FETCH_OBJ);
                          $totappoinment = $query4->rowCount();
                          ?>
                          <span class="report-title">Total Appointment</span>
                          <h4>
                            <?php echo htmlentities($totappoinment); ?>
                          </h4>
                          <a href="manage-appointment.php"><span class="report-count"> View Appointment</span></a>
                        </div>
